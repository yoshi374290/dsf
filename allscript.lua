...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      Title = "Yoshi Hub",
      Subtitle = "Yoshi's Key System",
      Note = "Key In Discord Server",
      FileName = "YoutubeHubKey1", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = false, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"https://pastebin.com/raw/9NEqs29b"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
local Dropdown = TPTab:CreateDropdown({
   Name = "My Socials",
   Options = {"youtube.com/channel/UCc7hSHT-x9XSj7HHgngnAcQ","Monkey D Yoshi#0111"},
   CurrentOption = {"Monkey D Yoshi#0111"},
   MultipleOptions = false,
